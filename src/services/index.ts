...
import v1ProfileVendorProfileManagement from './v1/profile/vendor-profile-management/vendor-profile-management.service';
...
export default function (app: Application): void {
    ...
    app.configure(v1ProfileVendorProfileManagement);
}
