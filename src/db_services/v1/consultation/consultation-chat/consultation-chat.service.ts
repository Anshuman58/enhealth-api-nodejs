...
declare module '../../../../declarations' {
    interface ServiceTypes {
        'v1/consultation/consultation-chat': ConsultationChat & ServiceAddons<any>;
    }
}
...
export default function (app: Application): void {
    ...
    app.use('/v1/consultation/consultation-chat', new ConsultationChat(options, app));

    // Get our initialized service so that we can register hooks
    const service = app.service('v1/consultation/consultation-chat');
