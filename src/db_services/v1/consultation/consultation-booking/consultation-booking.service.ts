...
declare module '../../../../declarations' {
    interface ServiceTypes {
        'v1/consultation/consultation-booking': ConsultationBooking & ServiceAddons<any>;
    }
}
...
export default function (app: Application): void {
    ...
    app.use('/v1/consultation/consultation-booking', new ConsultationBooking(options, app));

    // Get our initialized service so that we can register hooks
    const service = app.service('v1/consultation/consultation-booking');
